...
// This script is responsible for rendering the maze in the scene based on the maze data generated by the MazeGenerator script.
// It instantiates maze cell prefabs, configures their walls, and also handles the spawning of the exit door and the monster.
public class MazeRenderer : MonoBehaviour
{
    ...
    // This function spawns the exit door at the specified coordinates, which should be the top-right corner of the maze.
